...
- **Shell** --- [Xonsh](https://aur.archlinux.org/packages/xonsh-git) with [python-prompt_toolkit](https://archlinux.org/packages/community/any/python-prompt_toolkit/) using [Starship](https://aur.archlinux.org/packages/starship-git/) 
- **Completer** --- [Carapace](https://aur.archlinux.org/packages/carapace-bin)
