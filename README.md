...
- **Shell** --- [Bash](https://archlinux.org/packages/core/x86_64/bash/) with [ble.sh](https://aur.archlinux.org/packages/blesh-git) using [Starship](https://aur.archlinux.org/packages/starship-git/) 
